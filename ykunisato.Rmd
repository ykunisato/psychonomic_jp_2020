...
- 疾病分類とバイオマーカーの洗練化：計算論的検査(Computational assay, Stephan & Mathys, 2014)
...
- 68名の大学生に恐怖条件づけ実験を実施(CS:図形刺激，US:恐怖顔と叫び声）。アウトカム指標として，US予期。
-  $\alpha$ の高い人の方が，変動性が大きい（USの有無で反応が動きやすい）。 $\alpha$ の高い人の方が，CS-への反応が低くなりにくい（弁別が弱いor般化しやすい？）。
